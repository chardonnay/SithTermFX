...
import com.sithtermfx.core.TextStyle.Option;
import com.sithtermfx.core.compatibility.Point;
import com.sithtermfx.core.emulator.ColorPalette;
import com.sithtermfx.core.emulator.charset.CharacterSets;
...
import com.sithtermfx.core.model.TerminalLineIntervalHighlighting;
...
import com.sithtermfx.ui.hyperlinks.LinkInfoEx;
import com.sithtermfx.ui.input.FxMouseEvent;
import com.sithtermfx.ui.input.FxMouseWheelEvent;
...
public class TerminalPanel implements TerminalDisplay, TerminalActionProvider {
    ...
    private void sizeTerminalFromComponent() {
        if (myTerminalStarter != null) {
            ...
            if (newSize != null) {
                newSize = SithTerminal.ensureTermMinimumSize(newSize);
