...
public class BasicTerminalShellExample extends Application {
    ...
    private @NotNull SithTermFxWidget createTerminalWidget() {
        SithTermFxWidget widget = new SithTermFxWidget(80, 24, new DarkThemeSettingsProvider());
    ...
    public void start(Stage stage) {
        SithTermFxWidget widget = createTerminalWidget();
