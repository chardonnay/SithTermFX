...
import com.sithtermfx.core.util.CharBufferUtil;
...
public class BufferResizeTest {
    ...
    public void testResizeToBiggerHeight() {
        ...
        SithTerminal terminal = session.getTerminal();
    ...
    public void testTypeOnLastLineAndResizeWidth() {
        ...
        terminal.resize(new TermSize(3, 5), RequestOrigin.User); // SithTerminal.MIN_WIDTH = 5
        assertEquals(
                ">line\n" +
                        "1\n" +
                        ">line\n" +
