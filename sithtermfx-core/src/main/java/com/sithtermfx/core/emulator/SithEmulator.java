 ...
 * <p/>
 * Obtains data from the  {@link com.sithtermfx.core.TerminalDataStream}, interprets terminal ANSI escape
 * sequences as commands and directs them as well as plain data characters to
 * the  {@link com.sithtermfx.core.Terminal}
 *
 * @author Daniel Mengel
 */

public class SithEmulator extends DataStreamIteratingEmulator {

    private static final Logger logger = LoggerFactory.getLogger(SithEmulator.class);
    ...
    public SithEmulator(TerminalDataStream dataStream, Terminal terminal) {
