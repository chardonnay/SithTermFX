...
import com.sithtermfx.core.emulator.mouse.MouseButtonCodes;
import com.sithtermfx.core.emulator.mouse.MouseButtonModifierFlags;
import com.sithtermfx.core.emulator.mouse.MouseMode;
import com.sithtermfx.core.emulator.mouse.TerminalMouseListener;
import com.sithtermfx.core.emulator.mouse.MouseFormat;
import com.sithtermfx.core.TerminalCustomCommandListener;
...
import com.sithtermfx.core.TerminalCoordinates;
import com.sithtermfx.core.compatibility.Point;
import com.sithtermfx.core.input.MouseEvent;
import com.sithtermfx.core.input.MouseWheelEvent;
 ...
 */
public class SithTerminal implements Terminal, TerminalMouseListener, TerminalCoordinates {

    private static final Logger logger = LoggerFactory.getLogger(SithTerminal.class.getName());
    ...
    public SithTerminal(@NotNull TerminalDisplay display, @NotNull TerminalTextBuffer buf,
